...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Sosiaaliturvatunnus").press("ControlOrMeta+c")
    page.get_by_role("textbox", name="Sosiaaliturvatunnus").fill("010183-800N")
    page.get_by_role("button", name="jatkaa").click()
    # Navigate to the target URL
    page.goto("https://sit1asiointi.lahitapiola.fi/default/#/auth-redirect")
    page.get_by_role("button", name="Hyväksy kaikki").click()
    # Navigate to the target URL
    ...
    page.get_by_test_id("desktop-nav-menu-laskut").get_by_role("button", name="Laskut").click()
