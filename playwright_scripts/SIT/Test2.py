...
def run(playwright: Playwright) -> None:
    ...
    page.locator("label").filter(has_text="RELEASE_INVESTMENT_01").locator("div").nth(3).click()
    page.locator("label").filter(has_text="RELEASE_INVESTMENT_01").locator("div").nth(4).click()
